...
<form name="form1" method="post" action="cateok.php">
	...
	<table border=0 cellspacing='1' cellpadding='3' bgcolor='black'>
		<tr> 
			<td bgcolor='#CCFFCC' colspan=2>메뉴
<?php echo $html['submitvalue'] ; ?> </td>
		</tr>
		<tr> 
...
(
<?php echo $list['re'] ; ?>
) - [<a href="<?php echo $href["list"] ; ?>" target=_blank>보기</a>]
	</TD>
	<td nowrap> <div align="center"><a href="javascript: return false" onClick="window.open('
<?php echo $href['catesort'] ; ?>','_blank','toolbar=no,location=no,status=no,menubar=no,scrollbars=auto,resizable=no,width=350,height=100,top=30 left=30')">순서변경</a></div></td>
