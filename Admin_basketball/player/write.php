	...
	<td><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<form action="ok.php" method="post" name="write" id="write" onsubmit="return chkForm(this)" ENCTYPE='multipart/form-data'>
			...
			<tr bgcolor="999999" class="base">
				<td align="center" bgcolor="#EDE1F7" ><strong>시크릿용 선수사진  - 명함판 사진</strong></td>
				<td bgcolor="#FFFFFF"><input name="upfile" type="file" id="upfile" size="30" />
					&nbsp;&nbsp;(296 X 220) =&gt; Savers Secret 용
<table width="500"  border="0" cellspacing="0" cellpadding="0">
			...
			<tr bgcolor="999999" class="base">
				<td align="center" bgcolor="#EDE1F7" ><strong>메일 슬라이드용 png</strong></td>
				<td bgcolor="#FFFFFF"><input type="file" name="upfile0" size="30" />
					&nbsp;&nbsp;(470 X 690) =&gt;
		메인 슬라이드 사진
<table width="500"  border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="60%">파일명 :
								<?=$list['upfiles'][upfile0][name] ?></td>
							<td width="40%"><input name="del_upfile0" type="checkbox" id="del_upfile0" value="checkbox" />
								삭제 </td>
							</tr>
					</table></td>
			</tr>
			<tr bgcolor="999999" class="base">
				<td align="center" bgcolor="#EDE1F7" ><strong>선수소개 1 - 서 있는 사진</strong></td>
	   ...
	   <table width="500"  border="0" cellspacing="0" cellpadding="0">
			...
			<tr bgcolor="999999" class="base">
				<td align="center" bgcolor="#EDE1F7" ><strong>선수종합기록 1 - 명함판 사진</strong></td>
				<td bgcolor="#FFFFFF"><input type="file" name="upfile3" size="30" />
					&nbsp;&nbsp;(296 X 220) =&gt; 선수종합기록실 전체목록 사진
			...
			<tr bgcolor="999999" class="base">
				<td align="center" bgcolor="#EDE1F7" ><strong>선수종합기록 2 - 옆으로 넓은 사진</strong></td>
				<td bgcolor="#FFFFFF"><input type="file" name="upfile4" size="30" />
					&nbsp;&nbsp;(940 X 220) =&gt; 선수종합기록실 개인목록 사진
<table width="500"  border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="60%">파일명 :
